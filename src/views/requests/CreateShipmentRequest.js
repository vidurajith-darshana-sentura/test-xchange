...
const CreateShipmentRequest = ({ navigation }) => {
    ...
    useEffect(() => {
        console.log("createSellerRequestSuccess: ", createSellerRequestSuccess, createSellerRequestFailure)
        ...
        <View style={styles.container}>
            ...
            <View style={styles.background}>
                ...
                <View style={styles.baseForm}>
                    <Text style={{ fontSize: 25, paddingHorizontal: 10, paddingTop: 20 }}>Create Shipment Request</Text>
                    <View style={styles.textinput}>
...

                        {
                            isCalendarVisible ?
                                <Calendar
                                    onDayPress={(day) => setShipmentDate(day.dateString)}
                                />
                                : null
                        }
                        ...
                        <Button
                            disabled={!title || !description || !space || !country || !checked || !shipmentDate}
                            title="Post Request"
                            color="#20B2AA"
...
const styles = StyleSheet.create({
    ...
    buttonRegist: {
        paddingVertical: 10, alignItems: 'center', borderRadius: 20, backgroundColor: '#20B2AA', marginTop: 40, paddingHorizontal: 10
