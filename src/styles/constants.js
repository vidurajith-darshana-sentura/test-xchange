...
export const secondaryDarkColor = '#AE3465';
export const yellowColor = '#DAFE4C';
export const greenColor ='#20B2AA';
export const lightGreenColor = "#92d1ce";



export default {
    primahry: '#637aff',
    primaryjuyDark: '#2759ff',
    priyjmaryLite: '#637aff99',
    yh: '#000',
    white: 'white',
    accent: '#112233',
    green: '#60c5a8',
